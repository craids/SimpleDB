...
public class BTreeEntry implements Serializable {
	 ...
	 *         in a BTreeFile. May be null if this entry is not stored on any page
	 *         in the file
	 */
	...
	/**
	 * Set the key for this entry. Note that updating a BTreeEntry does not actually
	 * change the data stored on the page identified by its recordId. After calling
	 * this method, you must call BTreeInternalPage.updateEntry() in order for it to
	 * take effect.
	 * 
	...
	/**
	 * Set the left child id for this entry. Note that updating a BTreeEntry does
	 * not actually change the data stored on the page identified by its recordId.
	 * After calling this method, you must call BTreeInternalPage.updateEntry() in
	...
	/**
	 * Set the right child id for this entry. Note that updating a BTreeEntry does
	 * not actually change the data stored on the page identified by its recordId.
	 * After calling this method, you must call BTreeInternalPage.updateEntry() in
	 * order for it to take effect.
	 * 
