...
public class BTreeLeafPage extends BTreePage {
	...
	/**
	 * Create a BTreeLeafPage from a set of bytes of data read from disk. The format
	 * of a BTreeLeafPage is a set of header bytes indicating the slots of the page
	 * that are in use, and some number of tuple slots, as well as some extra bytes
	 * for the parent and sibling pointers. Specifically, the number of tuples is
	 * equal to:
	 * <p>
	 ...
	 * generated by getPageData to the BTreeLeafPage constructor and have it produce
	 * an identical BTreeLeafPage object.
	 *
	 * @see #BTreeLeafPage
	 ...
	 * order; the tuple should be updated to reflect that it is now stored on this
	 * page.
	 * 
