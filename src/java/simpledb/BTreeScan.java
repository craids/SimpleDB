...
public class BTreeScan implements OpIterator {
	...
	/**
	 * Creates a B+ tree scan over the specified table as a part of the specified
	 * transaction.
	 * 
	 ...
	 * @param ipred      The index predicate to match. If null, the scan will return
	 ...
	 * prefixed with the tableAlias string from the constructor. This prefix becomes
	 * useful when joining tables containing a field(s) with the same name.
	 * 
