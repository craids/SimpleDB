...
public class Aggregate extends Operator {
	...
	private OpIterator m_tupleIterator;
	...
	private OpIterator m_aggregateIterator;
	...
	public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
		...
		if (m_groupByFieldIndex == Aggregator.NO_GROUPING)
			...
			TupleDesc tmp = m_tupleIterator.getTupleDesc();
			groupByType = tmp.getFieldType(m_groupByFieldIndex);
		}
	 ...
	 *         field index in the <b>INPUT</b> tuples. If not, return return
	 *         m_aggregateIterator.next();
	 * 
	...
	public OpIterator[] getChildren() {
		// some code goes here
		return new OpIterator[] { m_aggregateIterator };
	}
