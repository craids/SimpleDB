...
public class IntHistogram {
	...
	private long estimateBucketCountOfLesserValues(int v) {
	...
	public double estimateSelectivity(Predicate.Op op, int v) {
		...
		case GREATER_THAN_OR_EQ:
		case GREATER_THAN:
			sufficientValuesEstimate += bucketCounts[bucketIndex] - estimateBucketCountOfLesserValues(v);
		...
		case LESS_THAN_OR_EQ:
		case LESS_THAN:
			sufficientValuesEstimate += estimateBucketCountOfLesserValues(v);
