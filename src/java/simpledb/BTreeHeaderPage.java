...
public class BTreeHeaderPage implements Page {
	 ...
	 * format of a BTreeHeaderPage is two pointers to the next and previous header
	 * pages, followed by a set of bytes indicating which pages in the file are used
	 * or available
	 * 
